...
<div class="col-sm-4"><div class="jumbotron bg-success" style="border:2px solid green;text-align: center;"><h3 class="animate-reveal animate-second text-center"><span style="font-size:15px">Supplier or Buyer</span></h3>
	<p>&nbsp</p>
