	 ...
	 <div class="form-group">
      <div class="text-danger"> <?php echo "$usernameErr";?></div>
        ...
        <span style="color: #060" class="glyphicon glyphicon-lock"></span></span>    <label style="color: #060" for="inputsurname">Create Password</label>
            <input type="password" name="password1" class="form-control" id="inputsurname" placeholder="must be 8 characters long" minlength="8" >
        ...
        <span style="color: #060" class="glyphicon glyphicon-lock"></span></span>    <label style="color: #060" for="inputsurname">Confirm Password</label>
            <input type="password" name="password" class="form-control" id="inputsurname" placeholder="must be 8 characters long matching the above" minlength="8">
...
<form name="bulk_action_form" action="action.php" method="post" onsubmit="return changeConfirm();" enctype="multipart/form-data"/ style="background-color: #CCC;padding: 5px;margin-top:3px;border-radius: 3px">
...
<input type="password" name="password" class="form-control" id="inputsurname" placeholder="Enter password please" required>
  ...
  <button type="submit" name="farmer"  class="btn btn-success"><span style="color:#FFF">Login</span></button> <hr>          
</form>
  </div>
</div>
