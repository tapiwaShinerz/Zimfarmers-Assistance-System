...
<form name="bulk_action_form" action="inc/login_processor.php" method="post" onsubmit="return changeConfirm();" enctype="multipart/form-data"/ style="background-color: #CCC;padding: 5px;margin-top:3px;border-radius: 3px">
...
<div id="advertise" class="modalDialog">
	<div>
		<a href="#close" title="Close" class="close">X</a>
<form name="bulk_action_form" action="farmer.php" method="post" onsubmit="return changeConfirm();" enctype="multipart/form-data"/ style="background-color: #CCC;padding: 5px;margin-top:3px;border-radius: 3px">
...
<div id="ask" class="modalDialog">
	<div>
		<a href="#close" title="Close" class="close">X</a>
<form  action="farmer.php" method="post" style="background-color: #CCC;padding: 5px;margin-top:3px;border-radius: 3px">
